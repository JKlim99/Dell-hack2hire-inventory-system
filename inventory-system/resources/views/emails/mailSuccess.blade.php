                                ...
                                <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr style="vertical-align:middle;" valign="middle">
                                        <td class="mso-padding alert alert-warning alert-dark" align="center"
                                            ...
                                            <p
                                                style="font-size:16px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;vertical-align:top;color:#fff;font-weight:500;text-align:center;border-radius:3px 3px 0 0;background-color:#50C878;margin:0;padding:20px;margin-top:0!important;margin-bottom:0!important;">
